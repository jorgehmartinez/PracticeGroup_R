...
De manera específica, se resalta el uso de funciones de dicho paquete
como: a) **geom_line**, que permite graficar la evolución de un
indicador a partir de una variable numérica y personalizar el gráfico
...
#### Variables identificadas:
    ...
    +==========+=============================+=============================+
    | variable | nombre del problema de      | Estrés, Depresión, Ansiedad |
    |          | salud mental                |                             |
    +----------+-----------------------------+-----------------------------+
    | segmento | grupo de docentes evaluados | General                     |
    |          |                             | Hombres, Mujeres,           |
    |          |                             | Urbano, Rural,              |
    |          |                             | Inicial, Primaria,          |
    |          |                             | Secundaria                  |
    +----------+-----------------------------+-----------------------------+
    | valor    | prevalencia, en porcentaje, | Rango: 4.01 a 65.20         |
    |          | del problema de salud       |                             |
    |          | mental                      |                             |
    +----------+-----------------------------+-----------------------------+
    | year     | año en que se realizó la    | Rango: 2014 a 2021          |
...
especificar un grupo de colores. Además, la función scale\_+\_continuous
permite delimitar el valor de inicio y fin de los ejes del gráfico, así
como definir la constante de salto en cada eje.
...
Se concluye que el algoritmo es efectivo en términos de sustraer,
manipular y graficar la data procedente del ESCALE Minedu,
específicamente de la Encuesta Nacional de Docentes (ENDO). A su vez, el
algoritmo resulta útil para visualizar la data según el segmento de
preferencia. Si bien existe alrededor de 120 paquetes de extensión del
ggplot2 que ofrece una versatilidad para la visualización de datos, a
futuro resultaría importante desarrollar algoritmos enfocados en la
dinámica y animación, con fin de facilitar el análisis de variables
continuas, sobre todo enfocado en la serie de tiempo. Ello contribuiría
a un análisis rápido y certero para autoridades o especialistas
involucrados en la toma de decisiones sobre políticas públicas en el
sector educación.
